...
class ProfileUpdate(UpdateView):
    ...
    def get_object(self, queryset=None):
        # Recuperar el objeto a editar, o crea uno en caso de no hallar el objeto
        # The object returns a tuple, with the profile, and a boolean to see if it was created or not
